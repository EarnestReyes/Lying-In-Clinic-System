...
export default function AppointmentsScreen() {
  ...
  const handleCreate = async () => {
    if (!formPatientName || !formService || !formDate) {
      Alert.alert("Missing Fields", "Please fill in patient name, service, and date.");
      return;
    }
      ...
      <View style={styles.appShell}>
        ...
        <View style={styles.sidebar}>
          ...
          <TouchableOpacity style={[styles.navItem, styles.navItemActive]} activeOpacity={0.8}>
            <Ionicons name="calendar" size={18} color="#0D9488" style={styles.navIcon} />
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.topNavbar}>
            <View style={styles.searchBox}>
              ...
              <TextInput 
                placeholder="Search patient name, service..."
            ...
            <ScrollView contentContainerStyle={{ gap: 12 }}>
              <View>
                ...
                <TextInput 
                  ...
                  onChangeText={setFormPatientName}
                />
              </View>
